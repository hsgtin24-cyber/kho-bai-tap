...
def main():
    ...
    topics_input = input("Chủ đề (cách nhau bởi dấu phẩy, vd: String, List, Set, Tuple, Dict, Math, Matrix, Two Pointers, Bitwise, Prefix Sum, Kadane, Hash Map, Segment Tree, DP, Greedy, Graph: ").strip()
